...
def run_demo():
    ...
    # Give the MITM time to start
    time.sleep(1)
    
    # Run the client (this will block until the client finishes)
    start_client()
    
    # Wait for threads to finish (they won't because they're daemons)
    try:
...
if __name__ == "__main__":
    # We need to import Colors from common.py
    from common import Colors
